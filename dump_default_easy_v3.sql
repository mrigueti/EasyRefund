...
INSERT INTO `administradores` VALUES (5,19);
...
CREATE TABLE `aprovadores` (
  `id_aprovador` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `cargos` (
  ...
  `nome_cargo` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `nfs` (
  ...
  `anexo_nf` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `notificacoes` (
  ...
  `mensagem_notif` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `setores` (
  ...
  `nome_setor` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `setores_unidades` VALUES (1,1),(4,1),(1,2),(2,2),(3,2),(2,3),(3,3),(5,3);
...
CREATE TABLE `solicitacoes` (
  ...
  `id_usuario` int DEFAULT NULL,
  `id_aprovador` int DEFAULT NULL,
  `status_solicitacao` enum('Pendente','Aprovada','Recusada') COLLATE utf8mb4_general_ci DEFAULT 'Pendente',
  ...
  `descricao` varchar(250) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `categoria` enum('Alimentação','Transporte','Hospedagem','Outros') COLLATE utf8mb4_general_ci NOT NULL,
  `pago` tinyint(1) DEFAULT '0',
  `desc_aprovador` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_administrador` int DEFAULT NULL,
  PRIMARY KEY (`id_solicitacao`),
  KEY `id_usuario` (`id_usuario`),
  KEY `id_aprovador` (`id_aprovador`),
  KEY `fk_id_administrador` (`id_administrador`),
  CONSTRAINT `fk_id_administrador` FOREIGN KEY (`id_administrador`) REFERENCES `administradores` (`id_administrador`),
...
CREATE TABLE `unidades` (
  ...
  `nome_unidade` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `cpf_usuario` char(11) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `id_setor` int DEFAULT NULL,
  `role_nome` enum('Funcionário','Aprovador','Gerente','Administrador') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Funcionário',
...
-- Dump completed on 2024-12-03 23:31:54
